<template>
  <div v-if="loaded">
    <a
      ...
      class="sideicons cart-number"
      v-bind:data-before-content="carts.length"
      id="dropdowncart"
    ></a>
    <div
      uk-dropdown="mode: click; toggle: #dropdowncart; pos: bottom-center;"
      class="cart-dropdwon"
      id="cartDive"
    >
      <div class="arrowcart"></div>
      <div class="cart-main uk-text-center uk-padding">
        ...
        <div v-if="loggedin">
          ...
          <a
            ...
            v-if="carts.length> 0"
          >BEZAHLEN</a>
          <a class="custom-button atag uk-width-1-1" v-if="carts.length == 0">Einkaufswagen ist leer</a>
        </div>
        <div v-if="!loggedin">
          <p class="center">
