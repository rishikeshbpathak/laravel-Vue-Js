  ...
  <div>
    <div class="uk-text-center">
      <h2 class="txt-blue fonth2 font24">
        Die nächsten Webinar-Termine von VitalAire | Diabetes
      </h2>
    </div>
    <br />
    <div>
          ...
          <template v-if="index <= listcount - 1">
            <div :key="index" style="margin-bottom: 10px">
              <div class="bgcolordirt uk-text-center" uk-grid>
                ...
                >
                  <div
                    class="uk-padding uk-padding-remove-horizontal uk-text-left"
                  >
...
@Component
export default class Listingwebinar extends Vue {
  ...
  getAllData() {
    ...
    axios.get(this.listwebinarurl).then((resp) => {
      ...
      this.listWebinars = this.removeNull(this.allStandardwebinars);
