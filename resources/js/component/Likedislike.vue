  ...
  <div class="uk-grid-match" uk-grid>
    ...
    <div class="uk-width-expand@m uk-width-1-1@s">
      <div>
        ...
        <div class="faq-m-top">
          <span class="txt-blue faq-font font24">{{ questioninfo.likes }}</span>
        </div>
      </div>
    </div>
    <div class="uk-width-expand@m uk-width-1-1@s padding-left-like">
      <div>
        ...
        <div class="faq-m-top">
          <span class="txt-blue faq-font font24">{{
            questioninfo.dislikes
          }}</span>
        </div>
      </div>
    </div>
...
export default class Likedislike extends Vue {
  ...
  loadlikes() {
    Axios.get(this.likeslist)
      .then((response) => {
        this.questioninfo = Object.assign([], response.data);
        this.interacted = "interacted" + this.questioninfo.id;
        this.checkbtn();
        // console.log("questions info", this.interacted);
      })
      .catch((error) => {
        console.log(error);
      });
