...
<div class="uk-position-relative">
  <div class="banner-content-absolute" uk-grid>
    <div class="uk-width-1-1 grid-center">
      <div>
        <span class="new-banner-content roboto wh">Veranstaltungen für Patienten</span><br><br>
        <span class="roboto wh sub-banner-content">Besuchen Sie VitalAire vor Ort und online</span>
      </div>
    </div>
  </div>
  <img class="banner-width"
    src="{{url('/assets/banner/vitalaire-diabetes-header-19-veranstaltungen-webinare-patienten.jpg')}}"
    alt="vitalaire-diabetes-header-19-veranstaltungen-webinare-patienten">
  <br class="mob">
</div>
...
<div class="cust-padding custom-padding-top uk-padding-remove-bottom">
  ...
  <h1 class="txt-blue fonth1 roboto-slab-regular">
    Patienten: VitalAire Veranstaltungen zur t:slim X2™
  </h1>

  <h2 class="txt-blue fonth2 font24" style="margin-top: -5px;">
    Für Erwachsene und Kinder mit Diabetes Typ 1 – die clevere Insulinpumpe live erleben
  </h2>
  ...
  <div class="" uk-grid>
    <div class="uk-width-2-3@m uk-width-1-1@s">
      <div class="uk-text-justify tslim-para">
        <br>
        <p class="font18">
          Ob Erwachsene, Kinder oder Angehörige, Sie alle sind herzlich eingeladen an Online-Webinaren zur t:slim X2
          Insulinpumpe von VitalAire teilzunehmen. Völlig kostenlos, aber mit vielen wichtigen Informationen zum Umgang
          mit der Insulinpumpe und Typ 1 Diabetes. Seien Sie online von der Couch aus dabei und sorgen Sie für ein
          entspanntes Leben mit der t:slim X2 Insulinpumpe.
          Auch in Ihrer Nähe ist das VitalAire Diabetes Team vor Ort und steht Ihnen bei Veranstaltungen Frage und
          Antwort. Schließlich liegt Ihre Gesundheit uns am Herzen.
        </p>
      </div>
    </div>
